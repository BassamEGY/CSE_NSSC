...
/// \brief Prints all elements in a Vector to the console (in order, starting with the first element)
...
/// \param comp Comparison function which returns 
///        - true, if the first argument occurs before the second argument in a sorted sequence, and
///        - false otherwise.
